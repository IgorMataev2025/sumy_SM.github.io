...
Namespace SumyPortal
    ...
    Public Class RegisterConsumer
        ...
        Protected Sub btnRegister_Click(sender As Object, e As EventArgs)
            ...
            ' циклом /loop, 2026-09-13) — перевірка ДО Page.IsValid: бот, що сліпо
            ' заповнює всі поля форми (включно з невидимим), не повинен навіть
            ' дізнатись, що трапилось щось інше, ніж "успішна" реєстрація —
            ' вдаємо успіх, нічого не зберігаючи.
